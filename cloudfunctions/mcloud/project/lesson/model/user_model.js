...
UserModel.DB_STRUCTURE = {
	...
	USER_COURSE_TOTAL_CNT: 'int|true|default=0|comment=当前课时数',
	USER_COURSE_USED_CNT: 'int|true|default=0|comment=已约课时数',
	USER_COURSE_TIME: 'int|false|comment=最近课时变动时间', 
